...
public class Conectar {
    ...
    private static final String USER = "id19189165_admin";
    private static final String PASSWORD = "IeutFZ!QP2{6*sG3";
    private static final String URL = "jdbc:mysql://databases.000webhost.com/id19189165_database";
